...
<p class="text-2xl font-semibold py-5">Ubah Informasi Pengumuman</p>
<form method="POST" action="{{ route('announcement.updateInfo', $dataInfo->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="md:w-3/4 bg-gray-200 border p-4 rounded-lg">
        <div class="mb-3">
            ...
            <input type="text" id="info" name="info"
                ...
                placeholder="Informasi Tambahan Lengkap" value="{{ $dataInfo->info }}" required />
        </div>
        <button type="submit"
