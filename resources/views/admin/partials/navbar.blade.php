        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    aria-controls="user-list" data-collapse-toggle="user-list">
                ...
                <ul id="user-list" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.adminList') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group {{ Route::currentRouteName() === 'admin.adminList' ? ' bg-gray-200' : 'hover:bg-gray-100'}}">Admin</a>
                    </li>
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Kreatif</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="pages-list" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group {{ Route::currentRouteName() === '/' ? ' bg-gray-200' : 'hover:bg-gray-100'}}">Aktivitas</a>
                    </li>
                    <li>
                        <a href="#"
